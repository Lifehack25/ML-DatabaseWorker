...
-- Sample locks
INSERT INTO locks (lock_name, album_title, seal_date, scan_count, created_at, user_id) VALUES
('Wedding Lock', 'Our Beautiful Wedding', '2024-06-15', 15, datetime('now', '-30 days'), 1),
('Anniversary Lock', 'Five Years Together', '2024-02-14', 8, datetime('now', '-60 days'), 1),
('Family Vacation', 'Summer 2024 Memories', NULL, 3, datetime('now', '-10 days'), 2),
('Baby Photos', 'Little Emma Grows Up', '2024-01-01', 22, datetime('now', '-90 days'), 4);
